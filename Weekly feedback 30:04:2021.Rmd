...
- total studies assessed at present: 99

- of full-text articles excluded with reasons: 20

- of full-text articles on waiting list: 28

- <u> of studies included in qualitative synthesis: 51 </u>
...
**Publication type**
<br>
Type of peer-reviewed publication assessed up to date
<br>
...
<font size="1"> *-- ANNOTATION: Carmen would you know how to adjust the count per country in ENV by publication and not by the total of countries registered in the column *sample_country*? Sorry, I couldn't find your comments on GitHub --* </font> 
<br>
...
<br>
*Note: Majority are single Vmax values extracted from articles missing values for* Km *and* alpha
...
#### Vmax values
<br>
Values for Vmax portrayed for registered *Range* and *Single* values by *nutrients*
<br>
...
plot1 <- ggarrange(r1, s1, ncol = 2, nrow = 1)

plot2 <- ggarrange(r2, s2, ncol = 2, nrow = 1)

annotate_figure(plot1, top = text_grob("Vmax values for nutrients", face="bold"),
                left = text_grob("Vmax"))
