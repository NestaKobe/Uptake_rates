...
- total studies assessed at present: 183

- of full-text articles excluded with reasons: 31

- of full-text articles on waiting list: 14   

- <u> of studies included in qualitative synthesis: 50 </u>
...
ggplot(gdata, aes(x=year, y=n)) +
      ...
      scale_x_continuous(limits=c(1980, 2021), breaks=seq(1980,2025,5)) +
      theme_bw() +
...
<br>
<br>
Alpha distribution by nutrients:
<br>
...
#Overlapping densities
    ggplot(data.range, aes(x=alpha, group=species_type, fill=species_type))+
          ...
          facet_grid(type_uptake~nutrient) +
          ggtitle("Alpha by nutrient for Algae vs Seagrass") + 
          labs(x="Alpha [l g^-1 dw h^-1 µM^-1]", y="Frequency") +
...
Vmax distribution by nutrients:
<br>
