...
*of full-text articles assessed for eligibility:* 346

- total studies assessed at present: 153

- of full-text articles excluded with reasons: 23

- of full-text articles on waiting list: 50

- <u> of studies included in qualitative synthesis: 80 </u>
...
# load SOURCES
data.sou  <- read_excel("~/Documents/IMBRSea/Thesis S4/Database uptake rate_14.05.2021.xlsx",
...
# load ENVIRONMENTAL
data.env  <- read_excel("~/Documents/IMBRSea/Thesis S4/Database uptake rate_14.05.2021.xlsx",
                        sheet="environmental",na="NA",skip=3)
str(data.env)
names(data.env)

# load EXPERIMENTAL
data.exp  <- read_excel("~/Documents/IMBRSea/Thesis S4/Database uptake rate_14.05.2021.xlsx",
